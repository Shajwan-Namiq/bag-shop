          ...
          <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
            ...
            <div className="sticky top-0">
              <div className="flex justify-between">
                <div className="text-white max-w-[35ch]">
                  <h1 className="text-2xl font-bold">
                    Name: Fun Product That Does Something Cool
                  </h1>

                  <p className="mt-0.5 text-sm">
                    Category : Highest Rated Product
                  </p>
                ...
                <p className="text-lg font-bold text-white">$119.99</p>
              </div>
              ...
              <form className="mt-8  ">
                ...
                <div className="border m-4 flex justify-center w-1/5">
                  <svg
