...
const CardsDetail = () => {
  return (
    <div>
      <p className="text-center p-3 text-3xl">Item Detail Page</p>
      <section>
          ...
          <div class="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
            ...
            <div class="sticky top-0">
              <div class="flex justify-between">
                <div class="text-white max-w-[35ch]">
                  <h1 class="text-2xl font-bold">
                    Name: Fun Product That Does Something Cool
                  </h1>

                  <p class="mt-0.5 text-sm">Category : Highest Rated Product</p>
                ...
                <p class="text-lg font-bold text-white">$119.99</p>
              </div>
              ...
              <form class="mt-8  ">
                <div class="mt-4 flex justify-between">
                  <p class="mb-1 text-lg font-bold text-red-600">
                    Total : $234.45
                  </p>
           ...
           <div class="border m-4 flex justify-center w-1/5">
